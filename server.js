...
async function callGemini(modelId, history, prompt, imageUrl, liveSearchContext) {
  ...
  try {
    ...
    // সিস্টেম ইনস্ট্রাকশন সেটআপ (পরিচয় সেটআপ)
    let systemNotice = `তুমি একজন ফেসবুক মেসেঞ্জার এআই অ্যাসিস্ট্যান্ট। তোমার নাম SuperNinja AI এবং তোমাকে তৈরি করেছেন Developer Irfan Khan। আজকের সঠিক তারিখ ও বার হলো ${today}।`;
